...
let changeAppointment = Object.assign({}, appointmentFixtures.oneapp);
...
test.serial('Appointmet#AssignedAndUpdate - exist - user - customer', async t => {
  ...
  console.log('El total de los usuario es: ' + JSON.stringify(appointmentFixtures.extend(oneAppointment, assign)) + '\n\n');
  ...
  t.true(_rec39._expr(_rec39._capt(_rec39._capt(_rec39._capt(AppointmentStub, 'arguments/0/callee/object/object').update, 'arguments/0/callee/object').calledWith(_rec39._capt(changeAppointment, 'arguments/0/arguments/0'), _rec39._capt(assign, 'arguments/0/arguments/1')), 'arguments/0'), {
    content: 't.true(AppointmentStub.update.calledWith(changeAppointment, assign), \'appointment.update should be called with specified args\')',
    filepath: 'tests/appointment-tests.js',
    line: 236,
    async: true,
  ...
  t.deepEqual(appointmentup, appointmentFixtures.extend(changeAppointment, assign), 'appointment should be the same');
});
//# sourceMappingURL=/home/shersnape/Ceiba/Java-Script/Tutorial/JavaScritp-Platzi/smallJS/smallJS-dbsql/node_modules/.cache/ava/66163f4acb29302ff6d2688daa639f45.js.map