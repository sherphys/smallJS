...
test.serial('Appointmet#CanceledAndUpdate - exist - user/admin - customer', async t => {
  ...
  // Primero buscamos el usuario
  t.true(_rec40._expr(_rec40._capt(_rec40._capt(_rec40._capt(UserStub, 'arguments/0/object/object').findOne, 'arguments/0/object').called, 'arguments/0'), {
    content: 't.true(UserStub.findOne.called, \'findOne (user) should be called on model\')',
    filepath: 'tests/appointment-tests.js',
    line: 256,
    async: true,
  ...
  t.true(_rec41._expr(_rec41._capt(_rec41._capt(_rec41._capt(UserStub, 'arguments/0/object/object').findOne, 'arguments/0/object').calledOnce, 'arguments/0'), {
    content: 't.true(UserStub.findOne.calledOnce, \'findOne (user) should be called twice\')',
    filepath: 'tests/appointment-tests.js',
    line: 257,
    async: true,
  ...
  t.true(_rec42._expr(_rec42._capt(_rec42._capt(_rec42._capt(UserStub, 'arguments/0/callee/object/object').findOne, 'arguments/0/callee/object').calledWith(_rec42._capt(ccidArgsCustomerOrAdmin, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(UserStub.findOne.calledWith(ccidArgsCustomerOrAdmin), \'findOne (user) should be called with ccid args\')',
    filepath: 'tests/appointment-tests.js',
    line: 258,
    async: true,
  ...
  // Volvemos a buscarlas por el id
  t.true(_rec43._expr(_rec43._capt(_rec43._capt(_rec43._capt(AppointmentStub, 'arguments/0/object/object').findById, 'arguments/0/object').called, 'arguments/0'), {
    content: 't.true(AppointmentStub.findById.called, \'findById (appoint) should be called on model\')',
    filepath: 'tests/appointment-tests.js',
    line: 261,
    async: true,
  ...
  t.true(_rec44._expr(_rec44._capt(_rec44._capt(_rec44._capt(AppointmentStub, 'arguments/0/object/object').findById, 'arguments/0/object').calledTwice, 'arguments/0'), {
    content: 't.true(AppointmentStub.findById.calledTwice, \'findById (appoint) should be called twice\')',
    filepath: 'tests/appointment-tests.js',
    line: 262,
    async: true,
  ...
  t.true(_rec45._expr(_rec45._capt(_rec45._capt(_rec45._capt(AppointmentStub, 'arguments/0/callee/object/object').findById, 'arguments/0/callee/object').calledWith(_rec45._capt(_rec45._capt(canceledAppointment, 'arguments/0/arguments/0/object').id, 'arguments/0/arguments/0')), 'arguments/0'), {
  ...
  // Al encontrarla, la actualizamos
  t.true(_rec46._expr(_rec46._capt(_rec46._capt(_rec46._capt(AppointmentStub, 'arguments/0/object/object').update, 'arguments/0/object').called, 'arguments/0'), {
    content: 't.true(AppointmentStub.update.called, \'appointment.update called on model\')',
    filepath: 'tests/appointment-tests.js',
    line: 269,
    async: true,
  ...
  t.true(_rec47._expr(_rec47._capt(_rec47._capt(_rec47._capt(AppointmentStub, 'arguments/0/object/object').update, 'arguments/0/object').calledOnce, 'arguments/0'), {
    content: 't.true(AppointmentStub.update.calledOnce, \'appointment.update should be called once\')',
    filepath: 'tests/appointment-tests.js',
    line: 270,
    async: true,
  ...
  t.true(_rec48._expr(_rec48._capt(_rec48._capt(_rec48._capt(AppointmentStub, 'arguments/0/callee/object/object').update, 'arguments/0/callee/object').calledWith(_rec48._capt(canceledAppointment, 'arguments/0/arguments/0')), 'arguments/0'), {
...
//# sourceMappingURL=/home/shersnape/Ceiba/Java-Script/Tutorial/JavaScritp-Platzi/smallJS/smallJS-dbsql/node_modules/.cache/ava/d3d6666b5d0b430d1bd884a30bb4b818.js.map