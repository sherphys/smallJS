...
test.serial('Appointmet#AssignedAndUpdate - exist - user - customer', async t => {
  ...
  t.true(_rec39._expr(_rec39._capt(_rec39._capt(_rec39._capt(AppointmentStub, 'arguments/0/callee/object/object').update, 'arguments/0/callee/object').calledWith(_rec39._capt(oneAppointment, 'arguments/0/arguments/0'), _rec39._capt(assign, 'arguments/0/arguments/1')), 'arguments/0'), {
    content: 't.true(AppointmentStub.update.calledWith(oneAppointment, assign), \'appointment.update should be called with specified args\')',
    filepath: 'tests/appointment-tests.js',
    line: 237,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AppointmentStub","range":[7,22]},"property":{"type":"Identifier","name":"update","range":[23,29]},"computed":false,"range":[7,29]},"property":{"type":"Identifier","name":"calledWith","range":[30,40]},"computed":false,"range":[7,40]},"arguments":[{"type":"Identifier","name":"oneAppointment","range":[41,55]},{"type":"Identifier","name":"assign","range":[57,63]}],"range":[7,64]},{"type":"StringLiteral","value":"appointment.update should be called with specified args","range":[66,123]}],"range":[0,124]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AppointmentStub","range":[7,22]},{"type":{"label":"."},"range":[22,23]},{"type":{"label":"name"},"value":"update","range":[23,29]},{"type":{"label":"."},"range":[29,30]},{"type":{"label":"name"},"value":"calledWith","range":[30,40]},{"type":{"label":"("},"range":[40,41]},{"type":{"label":"name"},"value":"oneAppointment","range":[41,55]},{"type":{"label":","},"range":[55,56]},{"type":{"label":"name"},"value":"assign","range":[57,63]},{"type":{"label":")"},"range":[63,64]},{"type":{"label":","},"range":[64,65]},{"type":{"label":"string"},"value":"appointment.update should be called with specified args","range":[66,123]},{"type":{"label":")"},"range":[123,124]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'appointment.update should be called with specified args');
