...
test.beforeEach(async () => {
  ...
  AppointmentStub.findById.withArgs(appointmentid).returns(Promise.resolve(appointmentFixtures.byId(appointmentid)));
...
test.serial('Appointmet#createOrUpdate - exist - user - doctor', async t => {
  ...
  t.true(_rec22._expr(_rec22._capt(_rec22._capt(_rec22._capt(AppointmentStub, 'arguments/0/object/object').update, 'arguments/0/object').called, 'arguments/0'), {
    content: 't.true(AppointmentStub.update.called, \'appointment.create called on model\')',
    filepath: 'tests/appointment-tests.js',
    line: 175,
    async: true,
  ...
  t.true(_rec23._expr(_rec23._capt(_rec23._capt(_rec23._capt(AppointmentStub, 'arguments/0/object/object').update, 'arguments/0/object').calledOnce, 'arguments/0'), {
    content: 't.true(AppointmentStub.update.calledOnce, \'appointment.create should be called once\')',
    filepath: 'tests/appointment-tests.js',
    line: 176,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AppointmentStub","range":[7,22]},"property":{"type":"Identifier","name":"update","range":[23,29]},"computed":false,"range":[7,29]},"property":{"type":"Identifier","name":"calledOnce","range":[30,40]},"computed":false,"range":[7,40]},{"type":"StringLiteral","value":"appointment.create should be called once","range":[42,84]}],"range":[0,85]}',
  ...
  t.true(_rec24._expr(_rec24._capt(_rec24._capt(_rec24._capt(AppointmentStub, 'arguments/0/callee/object/object').update, 'arguments/0/callee/object').calledWith(_rec24._capt(oneAppoint, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(AppointmentStub.update.calledWith(oneAppoint), \'appointment.create should be called with specified args\')',
    filepath: 'tests/appointment-tests.js',
    line: 177,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AppointmentStub","range":[7,22]},"property":{"type":"Identifier","name":"update","range":[23,29]},"computed":false,"range":[7,29]},"property":{"type":"Identifier","name":"calledWith","range":[30,40]},"computed":false,"range":[7,40]},"arguments":[{"type":"Identifier","name":"oneAppoint","range":[41,51]}],"range":[7,52]},{"type":"StringLiteral","value":"appointment.create should be called with specified args","range":[54,111]}],"range":[0,112]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AppointmentStub","range":[7,22]},{"type":{"label":"."},"range":[22,23]},{"type":{"label":"name"},"value":"update","range":[23,29]},{"type":{"label":"."},"range":[29,30]},{"type":{"label":"name"},"value":"calledWith","range":[30,40]},{"type":{"label":"("},"range":[40,41]},{"type":{"label":"name"},"value":"oneAppoint","range":[41,51]},{"type":{"label":")"},"range":[51,52]},{"type":{"label":","},"range":[52,53]},{"type":{"label":"string"},"value":"appointment.create should be called with specified args","range":[54,111]},{"type":{"label":")"},"range":[111,112]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'appointment.create should be called with specified args');
