...
let daysArgs = {
  ...
  UserStub.findOne.withArgs(ccidArgsCustomerAndAdmin).returns(Promise.resolve(appointmentFixtures.byCCidCustomerAndAdmin(ccidchange)));
...
test.serial('Appointmet#CanceledAndUpdate - exist - user/admin - customer', async t => {
  ...
  t.true(_rec42._expr(_rec42._capt(_rec42._capt(_rec42._capt(UserStub, 'arguments/0/callee/object/object').findOne, 'arguments/0/callee/object').calledWith(_rec42._capt(ccidArgsCustomerAndAdmin, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(UserStub.findOne.calledWith(ccidArgsCustomerAndAdmin), \'findOne (user) should be called with ccid args\')',
    filepath: 'tests/appointment-tests.js',
    line: 249,
    async: true,
