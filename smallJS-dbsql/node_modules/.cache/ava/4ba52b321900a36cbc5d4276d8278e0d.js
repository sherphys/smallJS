...
test.serial('Appointmet#AssignedAndUpdate - exist - user - customer', async t => {
  ...
  let appointment = await db.Appointment.assignedAndUpdate(ccidchange, oneAppointment.id);
  ...
  console.log('User: ' + JSON.stringify(AppointmentStub.findById.calledWith(oneAppointment.id)) + '\n\n');
...
//# sourceMappingURL=/home/shersnape/Ceiba/Java-Script/Tutorial/JavaScritp-Platzi/smallJS/smallJS-dbsql/node_modules/.cache/ava/4ba52b321900a36cbc5d4276d8278e0d.js.map