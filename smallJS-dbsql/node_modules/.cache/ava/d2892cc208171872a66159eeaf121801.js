...
test.serial('Appointmet#createOrUpdate - exist - user - doctor', async t => {
  ...
  t.true(_rec20._expr(_rec20._capt(_rec20._capt(_rec20._capt(AppointmentStub, 'arguments/0/object/object').findOne, 'arguments/0/object').calledTwice, 'arguments/0'), {
    content: 't.true(AppointmentStub.findOne.calledTwice, \'findOne (appoint) should be called twice\')',
    filepath: 'tests/appointment-tests.js',
    line: 168,
    async: true,
