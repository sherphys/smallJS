...
test.serial('SetupandCreate', async t => {
  ...
  t.true(_rec14._expr(_rec14._capt(_rec14._capt(_rec14._capt(UserStub, 'arguments/0/object/object').findAll, 'arguments/0/object').called, 'arguments/0'), {
    content: 't.true(UserStub.findAll.called, \'findAll should be called on model\')',
    filepath: 'tests/user-tests.js',
    line: 176,
    async: true,
  ...
  t.true(_rec15._expr(_rec15._capt(_rec15._capt(_rec15._capt(UserStub, 'arguments/0/object/object').findAll, 'arguments/0/object').calledOnce, 'arguments/0'), {
    content: 't.true(UserStub.findAll.calledOnce, \'findAll should be called once\')',
    filepath: 'tests/user-tests.js',
    line: 177,
    async: true,
  ...
  t.true(_rec16._expr(_rec16._capt(_rec16._capt(_rec16._capt(UserStub, 'arguments/0/callee/object/object').findAll, 'arguments/0/callee/object').calledWith(_rec16._capt(connectedArgs, 'arguments/0/arguments/0')), 'arguments/0'), {
