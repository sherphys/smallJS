...
test.serial('Appointmet#AssignedAndUpdate - exist - user - customer', async t => {
  ...
  t.true(_rec39._expr(_rec39._capt(_rec39._capt(_rec39._capt(AppointmentStub, 'arguments/0/callee/object/object').update, 'arguments/0/callee/object').calledWith(_rec39._capt(appointment, 'arguments/0/arguments/0'), _rec39._capt(assign, 'arguments/0/arguments/1')), 'arguments/0'), {
    content: 't.true(AppointmentStub.update.calledWith(appointment, assign), \'appointment.update should be called with specified args\')',
    filepath: 'tests/appointment-tests.js',
    line: 237,
    async: true,
