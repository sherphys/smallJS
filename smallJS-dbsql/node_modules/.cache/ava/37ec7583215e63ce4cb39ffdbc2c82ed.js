...
test.beforeEach(async () => {
  ...
  AppointmentStub.update.withArgs(assign).returns(Promise.resolve(appointmentFixtures.byextend(assign)));
...
test.serial('Appointmet#AssignedAndUpdate - exist - user - customer', async t => {
  ...
  t.true(_rec39._expr(_rec39._capt(_rec39._capt(_rec39._capt(AppointmentStub, 'arguments/0/callee/object/object').update, 'arguments/0/callee/object').calledWith(_rec39._capt(assign, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(AppointmentStub.update.calledWith(assign), \'appointment.update should be called with specified args\')',
    filepath: 'tests/appointment-tests.js',
    line: 239,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AppointmentStub","range":[7,22]},"property":{"type":"Identifier","name":"update","range":[23,29]},"computed":false,"range":[7,29]},"property":{"type":"Identifier","name":"calledWith","range":[30,40]},"computed":false,"range":[7,40]},"arguments":[{"type":"Identifier","name":"assign","range":[41,47]}],"range":[7,48]},{"type":"StringLiteral","value":"appointment.update should be called with specified args","range":[50,107]}],"range":[0,108]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AppointmentStub","range":[7,22]},{"type":{"label":"."},"range":[22,23]},{"type":{"label":"name"},"value":"update","range":[23,29]},{"type":{"label":"."},"range":[29,30]},{"type":{"label":"name"},"value":"calledWith","range":[30,40]},{"type":{"label":"("},"range":[40,41]},{"type":{"label":"name"},"value":"assign","range":[41,47]},{"type":{"label":")"},"range":[47,48]},{"type":{"label":","},"range":[48,49]},{"type":{"label":"string"},"value":"appointment.update should be called with specified args","range":[50,107]},{"type":{"label":")"},"range":[107,108]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'appointment.update should be called with specified args');
