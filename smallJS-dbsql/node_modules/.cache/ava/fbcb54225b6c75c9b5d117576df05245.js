...
test.serial('Appointmet#createOrUpdate - exist - user - doctor', async t => {
  ...
  // Luego creamos la cita
  t.true(_rec22._expr(_rec22._capt(_rec22._capt(_rec22._capt(AppointmentStub, 'arguments/0/object/object').create, 'arguments/0/object').called, 'arguments/0'), {
    content: 't.true(AppointmentStub.create.called, \'appointment.create called on model\')',
    filepath: 'tests/appointment-tests.js',
    line: 172,
    async: true,
  ...
  t.true(_rec23._expr(_rec23._capt(_rec23._capt(_rec23._capt(AppointmentStub, 'arguments/0/object/object').create, 'arguments/0/object').calledOnce, 'arguments/0'), {
    content: 't.true(AppointmentStub.create.calledOnce, \'appointment.create should be called once\')',
    filepath: 'tests/appointment-tests.js',
    line: 173,
    async: true,
  ...
  t.true(_rec24._expr(_rec24._capt(_rec24._capt(_rec24._capt(AppointmentStub, 'arguments/0/callee/object/object').create, 'arguments/0/callee/object').calledWith(_rec24._capt(oneAppoint, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(AppointmentStub.create.calledWith(oneAppoint), \'appointment.create should be called with specified args\')',
    filepath: 'tests/appointment-tests.js',
    line: 174,
    async: true,
