...
test.beforeEach(async () => {
  ...
  AppointmentStub.change = sandbox.stub();
  AppointmentStub.change.withArgs(changeAppointment, assign).returns(Promise.resolve(appointmentFixtures.extend(changeAppointment, assign)));
...
test.serial('Appointmet#AssignedAndUpdate - exist - user - customer', async t => {
  ...
  // Al encontrarla, la actualizamos
  t.true(_rec37._expr(_rec37._capt(_rec37._capt(_rec37._capt(AppointmentStub, 'arguments/0/object/object').change, 'arguments/0/object').called, 'arguments/0'), {
    content: 't.true(AppointmentStub.change.called, \'appointment.update called on model\')',
    filepath: 'tests/appointment-tests.js',
    line: 239,
    async: true,
  ...
  t.true(_rec38._expr(_rec38._capt(_rec38._capt(_rec38._capt(AppointmentStub, 'arguments/0/object/object').change, 'arguments/0/object').calledOnce, 'arguments/0'), {
    content: 't.true(AppointmentStub.change.calledOnce, \'appointment.update should be called once\')',
    filepath: 'tests/appointment-tests.js',
    line: 240,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AppointmentStub","range":[7,22]},"property":{"type":"Identifier","name":"change","range":[23,29]},"computed":false,"range":[7,29]},"property":{"type":"Identifier","name":"calledOnce","range":[30,40]},"computed":false,"range":[7,40]},{"type":"StringLiteral","value":"appointment.update should be called once","range":[42,84]}],"range":[0,85]}',
  ...
  t.true(_rec39._expr(_rec39._capt(_rec39._capt(_rec39._capt(AppointmentStub, 'arguments/0/callee/object/object').change, 'arguments/0/callee/object').calledWith(_rec39._capt(changeAppointment, 'arguments/0/arguments/0'), _rec39._capt(assign, 'arguments/0/arguments/1')), 'arguments/0'), {
    content: 't.true(AppointmentStub.change.calledWith(changeAppointment, assign), \'appointment.update should be called with specified args\')',
    filepath: 'tests/appointment-tests.js',
    line: 241,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AppointmentStub","range":[7,22]},"property":{"type":"Identifier","name":"change","range":[23,29]},"computed":false,"range":[7,29]},"property":{"type":"Identifier","name":"calledWith","range":[30,40]},"computed":false,"range":[7,40]},"arguments":[{"type":"Identifier","name":"changeAppointment","range":[41,58]},{"type":"Identifier","name":"assign","range":[60,66]}],"range":[7,67]},{"type":"StringLiteral","value":"appointment.update should be called with specified args","range":[69,126]}],"range":[0,127]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AppointmentStub","range":[7,22]},{"type":{"label":"."},"range":[22,23]},{"type":{"label":"name"},"value":"change","range":[23,29]},{"type":{"label":"."},"range":[29,30]},{"type":{"label":"name"},"value":"calledWith","range":[30,40]},{"type":{"label":"("},"range":[40,41]},{"type":{"label":"name"},"value":"changeAppointment","range":[41,58]},{"type":{"label":","},"range":[58,59]},{"type":{"label":"name"},"value":"assign","range":[60,66]},{"type":{"label":")"},"range":[66,67]},{"type":{"label":","},"range":[67,68]},{"type":{"label":"string"},"value":"appointment.update should be called with specified args","range":[69,126]},{"type":{"label":")"},"range":[126,127]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'appointment.update should be called with specified args');
