...
test.serial('Agent#createOrUpdate - exists', async t => {
  ...
  t.true(_rec26._expr(_rec26._capt(_rec26._capt(_rec26._capt(UserStub, 'arguments/0/callee/object/object').findOne, 'arguments/0/callee/object').calledWith(_rec26._capt(ccidArgs, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(UserStub.findOne.calledWith(ccidArgs), \'findOne should be called with uuid args\')',
    filepath: 'tests/user-tests.js',
    line: 175,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"UserStub","range":[7,15]},"property":{"type":"Identifier","name":"findOne","range":[16,23]},"computed":false,"range":[7,23]},"property":{"type":"Identifier","name":"calledWith","range":[24,34]},"computed":false,"range":[7,34]},"arguments":[{"type":"Identifier","name":"ccidArgs","range":[35,43]}],"range":[7,44]},{"type":"StringLiteral","value":"findOne should be called with uuid args","range":[46,87]}],"range":[0,88]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"UserStub","range":[7,15]},{"type":{"label":"."},"range":[15,16]},{"type":{"label":"name"},"value":"findOne","range":[16,23]},{"type":{"label":"."},"range":[23,24]},{"type":{"label":"name"},"value":"calledWith","range":[24,34]},{"type":{"label":"("},"range":[34,35]},{"type":{"label":"name"},"value":"ccidArgs","range":[35,43]},{"type":{"label":")"},"range":[43,44]},{"type":{"label":","},"range":[44,45]},{"type":{"label":"string"},"value":"findOne should be called with uuid args","range":[46,87]},{"type":{"label":")"},"range":[87,88]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'findOne should be called with uuid args');
  t.true(_rec27._expr(_rec27._capt(_rec27._capt(_rec27._capt(UserStub, 'arguments/0/object/object').update, 'arguments/0/object').called, 'arguments/0'), {
  ...
  t.true(_rec28._expr(_rec28._capt(_rec28._capt(_rec28._capt(UserStub, 'arguments/0/object/object').update, 'arguments/0/object').calledOnce, 'arguments/0'), {
  ...
  t.true(_rec29._expr(_rec29._capt(_rec29._capt(_rec29._capt(UserStub, 'arguments/0/callee/object/object').update, 'arguments/0/callee/object').calledWith(_rec29._capt(single, 'arguments/0/arguments/0')), 'arguments/0'), {
