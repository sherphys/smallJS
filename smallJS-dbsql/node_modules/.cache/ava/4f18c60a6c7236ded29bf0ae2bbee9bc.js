...
test.beforeEach(async () => {
  ...
  AppointmentStub.findAll.withArgs(daysArgs).returns(Promise.resolve(appointmentFixtures.days));
...
test.serial('Appointmet#findNoAssignedByDate', async t => {
  ...
  let appointment = await db.Appointment.findNoAssignedByDate(dayinit, dayend);

  // Buscamos con un alll
  t.true(_rec7._expr(_rec7._capt(_rec7._capt(_rec7._capt(AppointmentStub, 'arguments/0/object/object').findAll, 'arguments/0/object').called, 'arguments/0'), {
  ...
  t.true(_rec8._expr(_rec8._capt(_rec8._capt(_rec8._capt(AppointmentStub, 'arguments/0/object/object').findAll, 'arguments/0/object').calledOnce, 'arguments/0'), {
  ...
  t.true(_rec9._expr(_rec9._capt(_rec9._capt(_rec9._capt(AppointmentStub, 'arguments/0/callee/object/object').findAll, 'arguments/0/callee/object').calledWith(_rec9._capt(daysArgs, 'arguments/0/arguments/0')), 'arguments/0'), {
