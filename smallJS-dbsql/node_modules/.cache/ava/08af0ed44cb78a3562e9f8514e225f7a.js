...
test.serial('User#createOrUpdate - new - user - doctor', async t => {
  ...
  // let user = await db.User.createOrUpdate(customer)
  ...
  t.true(_rec8._expr(_rec8._capt(_rec8._capt(_rec8._capt(UserStub, 'arguments/0/callee/object/object').findOne, 'arguments/0/callee/object').calledWith(_rec8._capt(ccidArgs, 'arguments/0/arguments/0')), 'arguments/0'), {
  ...
  t.true(_rec9._expr(_rec9._capt(_rec9._capt(_rec9._capt(AppointmentStub, 'arguments/0/object/object').findOne, 'arguments/0/object').called, 'arguments/0'), {
    content: 't.true(AppointmentStub.findOne.called, \'findOne should be called on model\')',
    filepath: 'tests/appointment-tests.js',
    line: 111,
    async: true,
  ...
  t.true(_rec10._expr(_rec10._capt(_rec10._capt(_rec10._capt(AppointmentStub, 'arguments/0/object/object').findOne, 'arguments/0/object').calledOnce, 'arguments/0'), {
    content: 't.true(AppointmentStub.findOne.calledOnce, \'findOne should be called twice\')',
    filepath: 'tests/appointment-tests.js',
    line: 112,
    async: true,
  ...
  t.true(_rec12._expr(_rec12._capt(_rec12._capt(_rec12._capt(AppointmentStub, 'arguments/0/object/object').create, 'arguments/0/object').called, 'arguments/0'), {
    content: 't.true(AppointmentStub.create.called, \'agent.update called on model\')',
    filepath: 'tests/appointment-tests.js',
    line: 120,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AppointmentStub","range":[7,22]},"property":{"type":"Identifier","name":"create","range":[23,29]},"computed":false,"range":[7,29]},"property":{"type":"Identifier","name":"called","range":[30,36]},"computed":false,"range":[7,36]},{"type":"StringLiteral","value":"agent.update called on model","range":[38,68]}],"range":[0,69]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AppointmentStub","range":[7,22]},{"type":{"label":"."},"range":[22,23]},{"type":{"label":"name"},"value":"create","range":[23,29]},{"type":{"label":"."},"range":[29,30]},{"type":{"label":"name"},"value":"called","range":[30,36]},{"type":{"label":","},"range":[36,37]},{"type":{"label":"string"},"value":"agent.update called on model","range":[38,68]},{"type":{"label":")"},"range":[68,69]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'agent.update called on model');
  t.true(_rec13._expr(_rec13._capt(_rec13._capt(_rec13._capt(AppointmentStub, 'arguments/0/object/object').create, 'arguments/0/object').calledOnce, 'arguments/0'), {
    content: 't.true(AppointmentStub.create.calledOnce, \'agent.update should be called once\')',
    filepath: 'tests/appointment-tests.js',
    line: 121,
    async: true,
  ...
  t.true(_rec14._expr(_rec14._capt(_rec14._capt(_rec14._capt(AppointmentStub, 'arguments/0/callee/object/object').create, 'arguments/0/callee/object').calledWith(_rec14._capt(newAppointment, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(AppointmentStub.create.calledWith(newAppointment), \'agent.update should be called with specified args\')',
    filepath: 'tests/appointment-tests.js',
    line: 122,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AppointmentStub","range":[7,22]},"property":{"type":"Identifier","name":"create","range":[23,29]},"computed":false,"range":[7,29]},"property":{"type":"Identifier","name":"calledWith","range":[30,40]},"computed":false,"range":[7,40]},"arguments":[{"type":"Identifier","name":"newAppointment","range":[41,55]}],"range":[7,56]},{"type":"StringLiteral","value":"agent.update should be called with specified args","range":[58,109]}],"range":[0,110]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AppointmentStub","range":[7,22]},{"type":{"label":"."},"range":[22,23]},{"type":{"label":"name"},"value":"create","range":[23,29]},{"type":{"label":"."},"range":[29,30]},{"type":{"label":"name"},"value":"calledWith","range":[30,40]},{"type":{"label":"("},"range":[40,41]},{"type":{"label":"name"},"value":"newAppointment","range":[41,55]},{"type":{"label":")"},"range":[55,56]},{"type":{"label":","},"range":[56,57]},{"type":{"label":"string"},"value":"agent.update should be called with specified args","range":[58,109]},{"type":{"label":")"},"range":[109,110]}]',
    visitorKeys: _powerAssertVisitorKeys
