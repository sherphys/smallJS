...
let daysArgs = {
  ...
  AppointmentStub.update.withArgs(oneAppointment, changeAppointment).returns(Promise.resolve(changeAppointment));
...
test.serial('Appointmet#AssignedAndUpdate - exist - user - customer', async t => {
  ...
  let appointment = await db.Appointment.assignedAndUpdate(ccidchange, oneAppointment);
  ...
  t.true(_rec36._expr(_rec36._capt(_rec36._capt(_rec36._capt(AppointmentStub, 'arguments/0/callee/object/object').findById, 'arguments/0/callee/object').calledWith(_rec36._capt(_rec36._capt(oneAppointment, 'arguments/0/arguments/0/object').id, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(AppointmentStub.findById.calledWith(oneAppointment.id), \'findById (appoint) should be called with vargs\')',
    filepath: 'tests/appointment-tests.js',
    line: 236,
    async: true,
  ...
  t.true(_rec39._expr(_rec39._capt(_rec39._capt(_rec39._capt(AppointmentStub, 'arguments/0/callee/object/object').update, 'arguments/0/callee/object').calledWith(_rec39._capt(oneAppointment, 'arguments/0/arguments/0'), _rec39._capt(changeAppointment, 'arguments/0/arguments/1')), 'arguments/0'), {
    content: 't.true(AppointmentStub.update.calledWith(oneAppointment, changeAppointment), \'appointment.update should be called with specified args\')',
    filepath: 'tests/appointment-tests.js',
    line: 244,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AppointmentStub","range":[7,22]},"property":{"type":"Identifier","name":"update","range":[23,29]},"computed":false,"range":[7,29]},"property":{"type":"Identifier","name":"calledWith","range":[30,40]},"computed":false,"range":[7,40]},"arguments":[{"type":"Identifier","name":"oneAppointment","range":[41,55]},{"type":"Identifier","name":"changeAppointment","range":[57,74]}],"range":[7,75]},{"type":"StringLiteral","value":"appointment.update should be called with specified args","range":[77,134]}],"range":[0,135]}',
...
//# sourceMappingURL=/home/shersnape/Ceiba/Java-Script/Tutorial/JavaScritp-Platzi/smallJS/smallJS-dbsql/node_modules/.cache/ava/bd466fff6e4e1a7398362951b54e949c.js.map