...
test.serial('SetupandCreate', async t => {
  ...
  t.true(_rec13._expr(_rec13._capt(_rec13._capt(_rec13._capt(UserStub, 'arguments/0/callee/object/object').findAll, 'arguments/0/callee/object').calledWith(_rec13._capt(connectedArgs, 'arguments/0/arguments/0')), 'arguments/0'), {
  ...
  console.log("Los clientes conectados son: " + JSON.stringify(users) + " y en total son: " + JSON.stringify(usersall));
...
//# sourceMappingURL=/home/shersnape/Ceiba/Java-Script/Tutorial/JavaScritp-Platzi/smallJS/smallJS-dbsql/node_modules/.cache/ava/ddc05855a23a1ee76458d41bcd51ce69.js.map