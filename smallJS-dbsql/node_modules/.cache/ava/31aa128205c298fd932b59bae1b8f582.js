...
test.serial('Appointment#AssignedAndUpdate - exist - user - customer', async t => {
  ...
  t.true(_rec33._expr(_rec33._capt(_rec33._capt(_rec33._capt(UserStub, 'arguments/0/callee/object/object').findOne, 'arguments/0/callee/object').calledWith(_rec33._capt(ccidArgsCustomerOrAdmin, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(UserStub.findOne.calledWith(ccidArgsCustomerOrAdmin), \'findOne (user) should be called with ccid args\')',
    filepath: 'tests/appointment-tests.js',
    line: 236,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"UserStub","range":[7,15]},"property":{"type":"Identifier","name":"findOne","range":[16,23]},"computed":false,"range":[7,23]},"property":{"type":"Identifier","name":"calledWith","range":[24,34]},"computed":false,"range":[7,34]},"arguments":[{"type":"Identifier","name":"ccidArgsCustomerOrAdmin","range":[35,58]}],"range":[7,59]},{"type":"StringLiteral","value":"findOne (user) should be called with ccid args","range":[61,109]}],"range":[0,110]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"UserStub","range":[7,15]},{"type":{"label":"."},"range":[15,16]},{"type":{"label":"name"},"value":"findOne","range":[16,23]},{"type":{"label":"."},"range":[23,24]},{"type":{"label":"name"},"value":"calledWith","range":[24,34]},{"type":{"label":"("},"range":[34,35]},{"type":{"label":"name"},"value":"ccidArgsCustomerOrAdmin","range":[35,58]},{"type":{"label":")"},"range":[58,59]},{"type":{"label":","},"range":[59,60]},{"type":{"label":"string"},"value":"findOne (user) should be called with ccid args","range":[61,109]},{"type":{"label":")"},"range":[109,110]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'findOne (user) should be called with ccid args');
  ...
  t.true(_rec39._expr(_rec39._capt(_rec39._capt(_rec39._capt(AppointmentStub, 'arguments/0/callee/object/object').update, 'arguments/0/callee/object').calledWith(_rec39._capt(changeAppointment, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(AppointmentStub.update.calledWith(changeAppointment), \'appointment.update should be called with specified args\')',
    filepath: 'tests/appointment-tests.js',
    line: 249,
    async: true,
...
test.serial('Appointmet#CanceledAndUpdate - exist - user/admin - customer', async t => {
  ...
  t.true(_rec40._expr(_rec40._capt(_rec40._capt(_rec40._capt(UserStub, 'arguments/0/object/object').findOne, 'arguments/0/object').calledOnce, 'arguments/0'), {
    content: 't.true(UserStub.findOne.calledOnce, \'findOne (user) should be called twice\')',
    filepath: 'tests/appointment-tests.js',
    line: 258,
    async: true,
  ...
  t.true(_rec41._expr(_rec41._capt(_rec41._capt(_rec41._capt(UserStub, 'arguments/0/callee/object/object').findOne, 'arguments/0/callee/object').calledWith(_rec41._capt(ccidArgsCustomerOrAdmin, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(UserStub.findOne.calledWith(ccidArgsCustomerOrAdmin), \'findOne (user) should be called with ccid args\')',
    filepath: 'tests/appointment-tests.js',
    line: 259,
    async: true,
  ...
  // Volvemos a buscarlas por el id
  t.true(_rec42._expr(_rec42._capt(_rec42._capt(_rec42._capt(AppointmentStub, 'arguments/0/object/object').findById, 'arguments/0/object').called, 'arguments/0'), {
    content: 't.true(AppointmentStub.findById.called, \'findById (appoint) should be called on model\')',
    filepath: 'tests/appointment-tests.js',
    line: 262,
    async: true,
  ...
  t.true(_rec43._expr(_rec43._capt(_rec43._capt(_rec43._capt(AppointmentStub, 'arguments/0/object/object').findById, 'arguments/0/object').calledTwice, 'arguments/0'), {
    content: 't.true(AppointmentStub.findById.calledTwice, \'findById (appoint) should be called twice\')',
    filepath: 'tests/appointment-tests.js',
    line: 263,
    async: true,
  ...
  t.true(_rec44._expr(_rec44._capt(_rec44._capt(_rec44._capt(AppointmentStub, 'arguments/0/callee/object/object').findById, 'arguments/0/callee/object').calledWith(_rec44._capt(_rec44._capt(canceledAppointment, 'arguments/0/arguments/0/object').id, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(AppointmentStub.findById.calledWith(canceledAppointment.id), \'findById (appoint) should be called with vargs\')',
    filepath: 'tests/appointment-tests.js',
    line: 264,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AppointmentStub","range":[7,22]},"property":{"type":"Identifier","name":"findById","range":[23,31]},"computed":false,"range":[7,31]},"property":{"type":"Identifier","name":"calledWith","range":[32,42]},"computed":false,"range":[7,42]},"arguments":[{"type":"MemberExpression","object":{"type":"Identifier","name":"canceledAppointment","range":[43,62]},"property":{"type":"Identifier","name":"id","range":[63,65]},"computed":false,"range":[43,65]}],"range":[7,66]},{"type":"StringLiteral","value":"findById (appoint) should be called with vargs","range":[68,116]}],"range":[0,117]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AppointmentStub","range":[7,22]},{"type":{"label":"."},"range":[22,23]},{"type":{"label":"name"},"value":"findById","range":[23,31]},{"type":{"label":"."},"range":[31,32]},{"type":{"label":"name"},"value":"calledWith","range":[32,42]},{"type":{"label":"("},"range":[42,43]},{"type":{"label":"name"},"value":"canceledAppointment","range":[43,62]},{"type":{"label":"."},"range":[62,63]},{"type":{"label":"name"},"value":"id","range":[63,65]},{"type":{"label":")"},"range":[65,66]},{"type":{"label":","},"range":[66,67]},{"type":{"label":"string"},"value":"findById (appoint) should be called with vargs","range":[68,116]},{"type":{"label":")"},"range":[116,117]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'findById (appoint) should be called with vargs');
  ...
  // Al encontrarla, la actualizamos
  t.true(_rec45._expr(_rec45._capt(_rec45._capt(_rec45._capt(AppointmentStub, 'arguments/0/object/object').update, 'arguments/0/object').called, 'arguments/0'), {
    content: 't.true(AppointmentStub.update.called, \'appointment.update called on model\')',
    filepath: 'tests/appointment-tests.js',
    line: 270,
    async: true,
  ...
  t.true(_rec46._expr(_rec46._capt(_rec46._capt(_rec46._capt(AppointmentStub, 'arguments/0/object/object').update, 'arguments/0/object').calledOnce, 'arguments/0'), {
    content: 't.true(AppointmentStub.update.calledOnce, \'appointment.update should be called once\')',
    filepath: 'tests/appointment-tests.js',
    line: 271,
    async: true,
  ...
  t.true(_rec47._expr(_rec47._capt(_rec47._capt(_rec47._capt(AppointmentStub, 'arguments/0/callee/object/object').update, 'arguments/0/callee/object').calledWith(_rec47._capt(canceledAppointment, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(AppointmentStub.update.calledWith(canceledAppointment), \'appointment.update should be called with specified args\')',
    filepath: 'tests/appointment-tests.js',
    line: 272,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AppointmentStub","range":[7,22]},"property":{"type":"Identifier","name":"update","range":[23,29]},"computed":false,"range":[7,29]},"property":{"type":"Identifier","name":"calledWith","range":[30,40]},"computed":false,"range":[7,40]},"arguments":[{"type":"Identifier","name":"canceledAppointment","range":[41,60]}],"range":[7,61]},{"type":"StringLiteral","value":"appointment.update should be called with specified args","range":[63,120]}],"range":[0,121]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AppointmentStub","range":[7,22]},{"type":{"label":"."},"range":[22,23]},{"type":{"label":"name"},"value":"update","range":[23,29]},{"type":{"label":"."},"range":[29,30]},{"type":{"label":"name"},"value":"calledWith","range":[30,40]},{"type":{"label":"("},"range":[40,41]},{"type":{"label":"name"},"value":"canceledAppointment","range":[41,60]},{"type":{"label":")"},"range":[60,61]},{"type":{"label":","},"range":[61,62]},{"type":{"label":"string"},"value":"appointment.update should be called with specified args","range":[63,120]},{"type":{"label":")"},"range":[120,121]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'appointment.update should be called with specified args');

  t.deepEqual(appointment, canceledAppointment, 'appointment should be the same');
});
//# sourceMappingURL=/home/shersnape/Ceiba/Java-Script/Tutorial/JavaScritp-Platzi/smallJS/smallJS-dbsql/node_modules/.cache/ava/31aa128205c298fd932b59bae1b8f582.js.map