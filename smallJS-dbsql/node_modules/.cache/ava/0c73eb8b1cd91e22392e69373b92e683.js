...
test.serial('Appointmet#createOrUpdate - exist - user - doctor', async t => {
  ...
  t.true(_rec12._expr(_rec12._capt(_rec12._capt(_rec12._capt(AppointmentStub, 'arguments/0/callee/object/object').findOne, 'arguments/0/callee/object').calledWith(_rec12._capt(vArgs, 'arguments/0/arguments/0')), 'arguments/0'), {
  ...
  t.true(_rec13._expr(_rec13._capt(_rec13._capt(_rec13._capt(AppointmentStub, 'arguments/0/object/object').findById, 'arguments/0/object').called, 'arguments/0'), {
  ...
  t.true(_rec14._expr(_rec14._capt(_rec14._capt(_rec14._capt(AppointmentStub, 'arguments/0/object/object').findById, 'arguments/0/object').calledOnce, 'arguments/0'), {
  ...
  t.true(_rec15._expr(_rec15._capt(_rec15._capt(_rec15._capt(AppointmentStub, 'arguments/0/callee/object/object').findById, 'arguments/0/callee/object').calledWith(_rec15._capt(_rec15._capt(oneAppointment, 'arguments/0/arguments/0/object').id, 'arguments/0/arguments/0')), 'arguments/0'), {
  ...
  t.true(_rec16._expr(_rec16._capt(_rec16._capt(_rec16._capt(AppointmentStub, 'arguments/0/object/object').update, 'arguments/0/object').called, 'arguments/0'), {
  ...
  t.true(_rec17._expr(_rec17._capt(_rec17._capt(_rec17._capt(AppointmentStub, 'arguments/0/object/object').update, 'arguments/0/object').calledOnce, 'arguments/0'), {
  ...
  t.true(_rec18._expr(_rec18._capt(_rec18._capt(_rec18._capt(AppointmentStub, 'arguments/0/callee/object/object').update, 'arguments/0/callee/object').calledWith(_rec18._capt(oneAppointment, 'arguments/0/arguments/0')), 'arguments/0'), {
...
test.serial('Appointment#findNoAssignedByDate', async t => {
  ...
  t.true(_rec19._expr(_rec19._capt(_rec19._capt(_rec19._capt(AppointmentStub, 'arguments/0/object/object').findAll, 'arguments/0/object').called, 'arguments/0'), {
  ...
  t.true(_rec20._expr(_rec20._capt(_rec20._capt(_rec20._capt(AppointmentStub, 'arguments/0/object/object').findAll, 'arguments/0/object').calledOnce, 'arguments/0'), {
  ...
  t.true(_rec21._expr(_rec21._capt(_rec21._capt(_rec21._capt(AppointmentStub, 'arguments/0/callee/object/object').findAll, 'arguments/0/callee/object').calledWith(_rec21._capt(daysArgs, 'arguments/0/arguments/0')), 'arguments/0'), {
...
test.serial('Appointment#AssignedAndUpdate - exist - user - customer', async t => {
  ...
  // Primero buscamos el usuario
  t.true(_rec22._expr(_rec22._capt(_rec22._capt(_rec22._capt(UserStub, 'arguments/0/object/object').findOne, 'arguments/0/object').called, 'arguments/0'), {
    content: 't.true(UserStub.findOne.called, \'findOne (user) should be called on model\')',
    filepath: 'tests/appointment-tests.js',
    line: 232,
    async: true,
  ...
  t.true(_rec23._expr(_rec23._capt(_rec23._capt(_rec23._capt(UserStub, 'arguments/0/object/object').findOne, 'arguments/0/object').calledOnce, 'arguments/0'), {
    content: 't.true(UserStub.findOne.calledOnce, \'findOne (user) should be called twice\')',
    filepath: 'tests/appointment-tests.js',
    line: 233,
    async: true,
  ...
  t.true(_rec24._expr(_rec24._capt(_rec24._capt(_rec24._capt(UserStub, 'arguments/0/callee/object/object').findOne, 'arguments/0/callee/object').calledWith(_rec24._capt(ccidArgsCustomerOrAdmin, 'arguments/0/arguments/0')), 'arguments/0'), {
  ...
  // Volvemos a buscarlas por el id
  t.true(_rec25._expr(_rec25._capt(_rec25._capt(_rec25._capt(AppointmentStub, 'arguments/0/object/object').findById, 'arguments/0/object').called, 'arguments/0'), {
    content: 't.true(AppointmentStub.findById.called, \'findById (appoint) should be called on model\')',
    filepath: 'tests/appointment-tests.js',
    line: 237,
    async: true,
  ...
  t.true(_rec26._expr(_rec26._capt(_rec26._capt(_rec26._capt(AppointmentStub, 'arguments/0/object/object').findById, 'arguments/0/object').calledTwice, 'arguments/0'), {
  ...
  t.true(_rec27._expr(_rec27._capt(_rec27._capt(_rec27._capt(AppointmentStub, 'arguments/0/callee/object/object').findById, 'arguments/0/callee/object').calledWith(_rec27._capt(_rec27._capt(changeAppointment, 'arguments/0/arguments/0/object').id, 'arguments/0/arguments/0')), 'arguments/0'), {
  ...
  // Al encontrarla, la actualizamos
  t.true(_rec28._expr(_rec28._capt(_rec28._capt(_rec28._capt(AppointmentStub, 'arguments/0/object/object').update, 'arguments/0/object').called, 'arguments/0'), {
    content: 't.true(AppointmentStub.update.called, \'appointment.update called on model\')',
    filepath: 'tests/appointment-tests.js',
    line: 245,
    async: true,
  ...
  t.true(_rec29._expr(_rec29._capt(_rec29._capt(_rec29._capt(AppointmentStub, 'arguments/0/object/object').update, 'arguments/0/object').calledOnce, 'arguments/0'), {
    content: 't.true(AppointmentStub.update.calledOnce, \'appointment.update should be called once\')',
    filepath: 'tests/appointment-tests.js',
    line: 246,
    async: true,
  ...
  t.true(_rec30._expr(_rec30._capt(_rec30._capt(_rec30._capt(AppointmentStub, 'arguments/0/callee/object/object').update, 'arguments/0/callee/object').calledWith(_rec30._capt(changeAppointment, 'arguments/0/arguments/0')), 'arguments/0'), {
...
test.serial('Appointmet#CanceledAndUpdate - exist - user/admin - customer', async t => {
  ...
  t.true(_rec31._expr(_rec31._capt(_rec31._capt(_rec31._capt(UserStub, 'arguments/0/object/object').findOne, 'arguments/0/object').calledOnce, 'arguments/0'), {
    content: 't.true(UserStub.findOne.calledOnce, \'findOne (user) should be called twice\')',
    filepath: 'tests/appointment-tests.js',
    line: 256,
    async: true,
  ...
  t.true(_rec32._expr(_rec32._capt(_rec32._capt(_rec32._capt(UserStub, 'arguments/0/callee/object/object').findOne, 'arguments/0/callee/object').calledWith(_rec32._capt(ccidArgsCustomerOrAdmin, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(UserStub.findOne.calledWith(ccidArgsCustomerOrAdmin), \'findOne (user) should be called with ccid args\')',
    filepath: 'tests/appointment-tests.js',
    line: 257,
    async: true,
  ...
  // Volvemos a buscarlas por el id
  t.true(_rec33._expr(_rec33._capt(_rec33._capt(_rec33._capt(AppointmentStub, 'arguments/0/object/object').findById, 'arguments/0/object').called, 'arguments/0'), {
    content: 't.true(AppointmentStub.findById.called, \'findById (appoint) should be called on model\')',
    filepath: 'tests/appointment-tests.js',
    line: 260,
    async: true,
  ...
  t.true(_rec34._expr(_rec34._capt(_rec34._capt(_rec34._capt(AppointmentStub, 'arguments/0/object/object').findById, 'arguments/0/object').calledTwice, 'arguments/0'), {
    content: 't.true(AppointmentStub.findById.calledTwice, \'findById (appoint) should be called twice\')',
    filepath: 'tests/appointment-tests.js',
    line: 261,
    async: true,
  ...
  t.true(_rec35._expr(_rec35._capt(_rec35._capt(_rec35._capt(AppointmentStub, 'arguments/0/callee/object/object').findById, 'arguments/0/callee/object').calledWith(_rec35._capt(_rec35._capt(canceledAppointment, 'arguments/0/arguments/0/object').id, 'arguments/0/arguments/0')), 'arguments/0'), {
  ...
  // Al encontrarla, la actualizamos
  t.true(_rec36._expr(_rec36._capt(_rec36._capt(_rec36._capt(AppointmentStub, 'arguments/0/object/object').update, 'arguments/0/object').called, 'arguments/0'), {
    content: 't.true(AppointmentStub.update.called, \'appointment.update called on model\')',
    filepath: 'tests/appointment-tests.js',
    line: 268,
    async: true,
  ...
  t.true(_rec37._expr(_rec37._capt(_rec37._capt(_rec37._capt(AppointmentStub, 'arguments/0/object/object').update, 'arguments/0/object').calledOnce, 'arguments/0'), {
    content: 't.true(AppointmentStub.update.calledOnce, \'appointment.update should be called once\')',
    filepath: 'tests/appointment-tests.js',
    line: 269,
    async: true,
  ...
  t.true(_rec38._expr(_rec38._capt(_rec38._capt(_rec38._capt(AppointmentStub, 'arguments/0/callee/object/object').update, 'arguments/0/callee/object').calledWith(_rec38._capt(canceledAppointment, 'arguments/0/arguments/0')), 'arguments/0'), {
...
//# sourceMappingURL=/home/shersnape/Ceiba/Java-Script/Tutorial/JavaScritp-Platzi/smallJS/smallJS-dbsql/node_modules/.cache/ava/0c73eb8b1cd91e22392e69373b92e683.js.map