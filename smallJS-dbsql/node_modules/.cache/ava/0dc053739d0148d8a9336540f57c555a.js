...
test.serial('User#findByCCid', async t => {
  ...
  t.true(_rec13._expr(_rec13._capt(_rec13._capt(_rec13._capt(UserStub, 'arguments/0/callee/object/object').findOne, 'arguments/0/callee/object').calledWith(_rec13._capt(ccidArgs, 'arguments/0/arguments/0')), 'arguments/0'), {
...
test.serial('User#findByIPS', async t => {
  ...
  t.true(_rec14._expr(_rec14._capt(_rec14._capt(_rec14._capt(UserStub, 'arguments/0/object/object').findOne, 'arguments/0/object').called, 'arguments/0'), {
    content: 't.true(UserStub.findOne.called, \'findOne should be called on model\')',
    filepath: 'tests/user-tests.js',
    line: 141,
    async: true,
  ...
  t.true(_rec15._expr(_rec15._capt(_rec15._capt(_rec15._capt(UserStub, 'arguments/0/object/object').findOne, 'arguments/0/object').calledOnce, 'arguments/0'), {
    content: 't.true(UserStub.findOne.calledOnce, \'findOne should be called twice\')',
    filepath: 'tests/user-tests.js',
    line: 142,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"UserStub","range":[7,15]},"property":{"type":"Identifier","name":"findOne","range":[16,23]},"computed":false,"range":[7,23]},"property":{"type":"Identifier","name":"calledOnce","range":[24,34]},"computed":false,"range":[7,34]},{"type":"StringLiteral","value":"findOne should be called twice","range":[36,68]}],"range":[0,69]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"UserStub","range":[7,15]},{"type":{"label":"."},"range":[15,16]},{"type":{"label":"name"},"value":"findOne","range":[16,23]},{"type":{"label":"."},"range":[23,24]},{"type":{"label":"name"},"value":"calledOnce","range":[24,34]},{"type":{"label":","},"range":[34,35]},{"type":{"label":"string"},"value":"findOne should be called twice","range":[36,68]},{"type":{"label":")"},"range":[68,69]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'findOne should be called twice');
  t.true(_rec16._expr(_rec16._capt(_rec16._capt(_rec16._capt(UserStub, 'arguments/0/callee/object/object').findOne, 'arguments/0/callee/object').calledWith(_rec16._capt(ipsArgs, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(UserStub.findOne.calledWith(ipsArgs), \'findOne should be called with ips args\')',
    filepath: 'tests/user-tests.js',
    line: 143,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"UserStub","range":[7,15]},"property":{"type":"Identifier","name":"findOne","range":[16,23]},"computed":false,"range":[7,23]},"property":{"type":"Identifier","name":"calledWith","range":[24,34]},"computed":false,"range":[7,34]},"arguments":[{"type":"Identifier","name":"ipsArgs","range":[35,42]}],"range":[7,43]},{"type":"StringLiteral","value":"findOne should be called with ips args","range":[45,85]}],"range":[0,86]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"UserStub","range":[7,15]},{"type":{"label":"."},"range":[15,16]},{"type":{"label":"name"},"value":"findOne","range":[16,23]},{"type":{"label":"."},"range":[23,24]},{"type":{"label":"name"},"value":"calledWith","range":[24,34]},{"type":{"label":"("},"range":[34,35]},{"type":{"label":"name"},"value":"ipsArgs","range":[35,42]},{"type":{"label":")"},"range":[42,43]},{"type":{"label":","},"range":[43,44]},{"type":{"label":"string"},"value":"findOne should be called with ips args","range":[45,85]},{"type":{"label":")"},"range":[85,86]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'findOne should be called with ips args');
...
test.serial('User#createOrUpdate - new', async t => {
  ...
  t.true(_rec17._expr(_rec17._capt(_rec17._capt(_rec17._capt(UserStub, 'arguments/0/object/object').findOne, 'arguments/0/object').called, 'arguments/0'), {
    content: 't.true(UserStub.findOne.called, \'findOne should be called on model\')',
    filepath: 'tests/user-tests.js',
    line: 150,
    async: true,
  ...
  t.true(_rec18._expr(_rec18._capt(_rec18._capt(_rec18._capt(UserStub, 'arguments/0/object/object').findOne, 'arguments/0/object').calledTwice, 'arguments/0'), {
    content: 't.true(UserStub.findOne.calledTwice, \'findOne should be called once\')',
    filepath: 'tests/user-tests.js',
    line: 151,
    async: true,
  ...
  // Para el id
  t.true(_rec19._expr(_rec19._capt(_rec19._capt(_rec19._capt(UserStub, 'arguments/0/callee/object/object').findOne, 'arguments/0/callee/object').calledWith(_rec19._capt({
    where: _rec19._capt({ ccid: _rec19._capt(_rec19._capt(newUser, 'arguments/0/arguments/0/properties/0/value/properties/0/value/object').ccid, 'arguments/0/arguments/0/properties/0/value/properties/0/value') }, 'arguments/0/arguments/0/properties/0/value')
  ...
  t.true(_rec22._expr(_rec22._capt(_rec22._capt(_rec22._capt(UserStub, 'arguments/0/object/object').create, 'arguments/0/object').calledOnce, 'arguments/0'), {
  ...
  t.true(_rec23._expr(_rec23._capt(_rec23._capt(_rec23._capt(UserStub, 'arguments/0/callee/object/object').create, 'arguments/0/callee/object').calledWith(_rec23._capt(newUser, 'arguments/0/arguments/0')), 'arguments/0'), {
...
test.serial('User#createOrUpdate - exists', async t => {
  ...
  t.true(_rec24._expr(_rec24._capt(_rec24._capt(_rec24._capt(UserStub, 'arguments/0/object/object').findOne, 'arguments/0/object').called, 'arguments/0'), {
    content: 't.true(UserStub.findOne.called, \'findOne should be called on model\')',
    filepath: 'tests/user-tests.js',
    line: 173,
    async: true,
  ...
  t.true(_rec25._expr(_rec25._capt(_rec25._capt(_rec25._capt(UserStub, 'arguments/0/object/object').findOne, 'arguments/0/object').calledThrice, 'arguments/0'), {
    content: 't.true(UserStub.findOne.calledThrice, \'findOne should be called twice\')',
    filepath: 'tests/user-tests.js',
    line: 174,
    async: true,
  ...
  t.true(_rec26._expr(_rec26._capt(_rec26._capt(_rec26._capt(UserStub, 'arguments/0/callee/object/object').findOne, 'arguments/0/callee/object').calledWith(_rec26._capt(ccidArgs, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(UserStub.findOne.calledWith(ccidArgs), \'findOne should be called with ccid args\')',
    filepath: 'tests/user-tests.js',
    line: 175,
    async: true,
  ...
  t.true(_rec27._expr(_rec27._capt(_rec27._capt(_rec27._capt(UserStub, 'arguments/0/callee/object/object').findOne, 'arguments/0/callee/object').calledWith(_rec27._capt(ipsArgs, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(UserStub.findOne.calledWith(ipsArgs), \'findOne should be called with ips args\')',
    filepath: 'tests/user-tests.js',
    line: 176,
    async: true,
  ...
  t.true(_rec28._expr(_rec28._capt(_rec28._capt(_rec28._capt(UserStub, 'arguments/0/object/object').update, 'arguments/0/object').called, 'arguments/0'), {
  ...
  t.true(_rec29._expr(_rec29._capt(_rec29._capt(_rec29._capt(UserStub, 'arguments/0/object/object').update, 'arguments/0/object').calledOnce, 'arguments/0'), {
  ...
  t.true(_rec30._expr(_rec30._capt(_rec30._capt(_rec30._capt(UserStub, 'arguments/0/callee/object/object').update, 'arguments/0/callee/object').calledWith(_rec30._capt(single, 'arguments/0/arguments/0')), 'arguments/0'), {
