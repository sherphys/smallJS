...
test.serial('Appointmet#AssignedAndUpdate - exist - user - customer', async t => {
  ...
  let appointment = await db.Appointment.assignedAndUpdate(ccid, oneAppointment);
  ...
  t.true(_rec39._expr(_rec39._capt(_rec39._capt(_rec39._capt(AppointmentStub, 'arguments/0/callee/object/object').update, 'arguments/0/callee/object').calledWith(_rec39._capt(oneAppointment, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(AppointmentStub.update.calledWith(oneAppointment), \'appointment.update should be called with specified args\')',
    filepath: 'tests/appointment-tests.js',
    line: 228,
    async: true,
