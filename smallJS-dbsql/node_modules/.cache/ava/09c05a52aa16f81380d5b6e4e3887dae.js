...
test.serial('User#findById', async t => {
  ...
  t.true(_rec13._expr(_rec13._capt(_rec13._capt(_rec13._capt(UserStub, 'arguments/0/object/object').findById, 'arguments/0/object').called, 'arguments/0'), {
  ...
  t.true(_rec14._expr(_rec14._capt(_rec14._capt(_rec14._capt(UserStub, 'arguments/0/object/object').findById, 'arguments/0/object').calledOnce, 'arguments/0'), {
  ...
  t.true(_rec15._expr(_rec15._capt(_rec15._capt(_rec15._capt(UserStub, 'arguments/0/callee/object/object').findById, 'arguments/0/callee/object').calledWith(_rec15._capt(id, 'arguments/0/arguments/0')), 'arguments/0'), {
...
test.serial('User#findAll', async t => {
  ...
  t.true(_rec19._expr(_rec19._capt(_rec19._capt(_rec19._capt(UserStub, 'arguments/0/object/object').findAll, 'arguments/0/object').called, 'arguments/0'), {
    content: 't.true(UserStub.findAll.called, \'findAll should be called on model\')',
    filepath: 'tests/user-tests.js',
    line: 194,
    async: true,
  ...
  t.true(_rec20._expr(_rec20._capt(_rec20._capt(_rec20._capt(UserStub, 'arguments/0/object/object').findAll, 'arguments/0/object').calledOnce, 'arguments/0'), {
    content: 't.true(UserStub.findAll.calledOnce, \'findAll should be called once\')',
    filepath: 'tests/user-tests.js',
    line: 195,
    async: true,
  ...
  t.true(_rec21._expr(_rec21._capt(_rec21._capt(_rec21._capt(UserStub, 'arguments/0/callee/object/object').findAll, 'arguments/0/callee/object').calledWith(), 'arguments/0'), {
