...
test.serial('User#findById', async t => {
  ...
  t.true(_rec7._expr(_rec7._capt(_rec7._capt(_rec7._capt(UserStub, 'arguments/0/object/object').findById, 'arguments/0/object').called, 'arguments/0'), {
  ...
  t.true(_rec8._expr(_rec8._capt(_rec8._capt(_rec8._capt(UserStub, 'arguments/0/object/object').findById, 'arguments/0/object').calledOnce, 'arguments/0'), {
  ...
  t.true(_rec9._expr(_rec9._capt(_rec9._capt(_rec9._capt(UserStub, 'arguments/0/callee/object/object').findById, 'arguments/0/callee/object').calledWith(_rec9._capt(id, 'arguments/0/arguments/0')), 'arguments/0'), {
...
test.serial('User#findByCCid', async t => {
  ...
  t.true(_rec10._expr(_rec10._capt(_rec10._capt(_rec10._capt(UserStub, 'arguments/0/object/object').findOne, 'arguments/0/object').called, 'arguments/0'), {
    content: 't.true(UserStub.findOne.called, \'findOne should be called on model\')',
    filepath: 'tests/user-tests.js',
    line: 174,
    async: true,
  ...
  t.true(_rec11._expr(_rec11._capt(_rec11._capt(_rec11._capt(UserStub, 'arguments/0/object/object').findOne, 'arguments/0/object').calledOnce, 'arguments/0'), {
    content: 't.true(UserStub.findOne.calledOnce, \'findOne should be called once\')',
    filepath: 'tests/user-tests.js',
    line: 175,
    async: true,
  ...
  t.true(_rec12._expr(_rec12._capt(_rec12._capt(_rec12._capt(UserStub, 'arguments/0/callee/object/object').findOne, 'arguments/0/callee/object').calledWith(_rec12._capt(ccidArgs, 'arguments/0/arguments/0')), 'arguments/0'), {
...
test.serial('User#findAll', async t => {
  ...
  t.true(_rec13._expr(_rec13._capt(_rec13._capt(_rec13._capt(UserStub, 'arguments/0/object/object').findAll, 'arguments/0/object').called, 'arguments/0'), {
  ...
  t.true(_rec14._expr(_rec14._capt(_rec14._capt(_rec14._capt(UserStub, 'arguments/0/object/object').findAll, 'arguments/0/object').calledOnce, 'arguments/0'), {
  ...
  t.true(_rec15._expr(_rec15._capt(_rec15._capt(_rec15._capt(UserStub, 'arguments/0/callee/object/object').findAll, 'arguments/0/callee/object').calledWith(), 'arguments/0'), {
...
test.serial('User#findGroup', async t => {
  ...
  t.true(_rec16._expr(_rec16._capt(_rec16._capt(_rec16._capt(UserStub, 'arguments/0/object/object').findAll, 'arguments/0/object').called, 'arguments/0'), {
    content: 't.true(UserStub.findAll.called, \'findAll should be called on model\')',
    filepath: 'tests/user-tests.js',
    line: 196,
    async: true,
  ...
  t.true(_rec17._expr(_rec17._capt(_rec17._capt(_rec17._capt(UserStub, 'arguments/0/object/object').findAll, 'arguments/0/object').calledOnce, 'arguments/0'), {
    content: 't.true(UserStub.findAll.calledOnce, \'findAll should be called once\')',
    filepath: 'tests/user-tests.js',
    line: 197,
    async: true,
  ...
  t.true(_rec18._expr(_rec18._capt(_rec18._capt(_rec18._capt(UserStub, 'arguments/0/callee/object/object').findAll, 'arguments/0/callee/object').calledWith(_rec18._capt(typeArgs, 'arguments/0/arguments/0')), 'arguments/0'), {
