...
test.serial('Appointmet#createOrUpdate - new - user - doctor', async t => {
  ...
  //Ahora comprobemos la condición de creación
  t.true(_rec13._expr(_rec13._capt(_rec13._capt(_rec13._capt(_rec13._capt(_rec13._capt(UserStub, 'arguments/0/left/object/callee/object/object').findOne, 'arguments/0/left/object/callee/object').calledWith(_rec13._capt(ccidArgs, 'arguments/0/left/object/arguments/0')), 'arguments/0/left/object').type, 'arguments/0/left') === 'doctor', 'arguments/0'), {
    content: 't.true(UserStub.findOne.calledWith(ccidArgs).type === \'doctor\')',
    filepath: 'tests/appointment-tests.js',
    line: 143,
    async: true,
    ...
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"UserStub","range":[7,15]},{"type":{"label":"."},"range":[15,16]},{"type":{"label":"name"},"value":"findOne","range":[16,23]},{"type":{"label":"."},"range":[23,24]},{"type":{"label":"name"},"value":"calledWith","range":[24,34]},{"type":{"label":"("},"range":[34,35]},{"type":{"label":"name"},"value":"ccidArgs","range":[35,43]},{"type":{"label":")"},"range":[43,44]},{"type":{"label":"."},"range":[44,45]},{"type":{"label":"name"},"value":"type","range":[45,49]},{"type":{"label":"==/!="},"value":"===","range":[50,53]},{"type":{"label":"string"},"value":"doctor","range":[54,62]},{"type":{"label":")"},"range":[62,63]}]',
    visitorKeys: _powerAssertVisitorKeys
  }));

  // Luego creamos la cita
  t.true(_rec14._expr(_rec14._capt(_rec14._capt(_rec14._capt(AppointmentStub, 'arguments/0/object/object').create, 'arguments/0/object').called, 'arguments/0'), {
  ...
  t.true(_rec15._expr(_rec15._capt(_rec15._capt(_rec15._capt(AppointmentStub, 'arguments/0/object/object').create, 'arguments/0/object').calledOnce, 'arguments/0'), {
  ...
  t.true(_rec16._expr(_rec16._capt(_rec16._capt(_rec16._capt(AppointmentStub, 'arguments/0/callee/object/object').create, 'arguments/0/callee/object').calledWith(_rec16._capt(newAppointment, 'arguments/0/arguments/0')), 'arguments/0'), {
