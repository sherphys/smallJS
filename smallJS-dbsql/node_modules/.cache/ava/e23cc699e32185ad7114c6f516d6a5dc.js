...
test.beforeEach(async () => {
  ...
  UserStub.findAll.withArgs(connectArgs).returns(Promise.resolve(userFixtures.connected));
...
test.serial('SetupandCreate', async t => {
  ...
  console.log('El total de los clientes es: ' + JSON.stringify(usersall) + '\n\n');
  ...
  t.true(_rec11._expr(_rec11._capt(_rec11._capt(_rec11._capt(UserStub, 'arguments/0/callee/object/object').findAll, 'arguments/0/callee/object').calledWith(), 'arguments/0'), {
  ...
  console.log('El total de los clientes conectados es: ' + JSON.stringify(users) + '\n\n');

  //t.true(UserStub.findAll.called, 'findAll should be called on model')
  //t.true(UserStub.findAll.called, 'findAll should be called once')
  t.true(_rec12._expr(_rec12._capt(_rec12._capt(_rec12._capt(UserStub, 'arguments/0/callee/object/object').findAll, 'arguments/0/callee/object').calledWith(_rec12._capt(connectedArgs, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(UserStub.findAll.calledWith(connectedArgs), \'findAll should be called without args\')',
    filepath: 'tests/user-tests.js',
    line: 178,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"UserStub","range":[7,15]},"property":{"type":"Identifier","name":"findAll","range":[16,23]},"computed":false,"range":[7,23]},"property":{"type":"Identifier","name":"calledWith","range":[24,34]},"computed":false,"range":[7,34]},"arguments":[{"type":"Identifier","name":"connectedArgs","range":[35,48]}],"range":[7,49]},{"type":"StringLiteral","value":"findAll should be called without args","range":[51,90]}],"range":[0,91]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"UserStub","range":[7,15]},{"type":{"label":"."},"range":[15,16]},{"type":{"label":"name"},"value":"findAll","range":[16,23]},{"type":{"label":"."},"range":[23,24]},{"type":{"label":"name"},"value":"calledWith","range":[24,34]},{"type":{"label":"("},"range":[34,35]},{"type":{"label":"name"},"value":"connectedArgs","range":[35,48]},{"type":{"label":")"},"range":[48,49]},{"type":{"label":","},"range":[49,50]},{"type":{"label":"string"},"value":"findAll should be called without args","range":[51,90]},{"type":{"label":")"},"range":[90,91]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'findAll should be called without args');

  user = await db.User.findByCCid(ccid);
  console.log('El cliente encontrado es: ' + JSON.stringify(user) + '\n\n');
  ...
  users = await db.User.findConnected();
  console.log('El total de los clientes conectados es: ' + JSON.stringify(users) + '\n\n');
  t.true(_rec14._expr(_rec14._capt(_rec14._capt(_rec14._capt(UserStub, 'arguments/0/callee/object/object').findAll, 'arguments/0/callee/object').calledWith(_rec14._capt(connectedArgs, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(UserStub.findAll.calledWith(connectedArgs), \'findAll should be called with connected args\')',
    filepath: 'tests/user-tests.js',
    line: 189,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"UserStub","range":[7,15]},"property":{"type":"Identifier","name":"findAll","range":[16,23]},"computed":false,"range":[7,23]},"property":{"type":"Identifier","name":"calledWith","range":[24,34]},"computed":false,"range":[7,34]},"arguments":[{"type":"Identifier","name":"connectedArgs","range":[35,48]}],"range":[7,49]},{"type":"StringLiteral","value":"findAll should be called with connected args","range":[51,97]}],"range":[0,98]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"UserStub","range":[7,15]},{"type":{"label":"."},"range":[15,16]},{"type":{"label":"name"},"value":"findAll","range":[16,23]},{"type":{"label":"."},"range":[23,24]},{"type":{"label":"name"},"value":"calledWith","range":[24,34]},{"type":{"label":"("},"range":[34,35]},{"type":{"label":"name"},"value":"connectedArgs","range":[35,48]},{"type":{"label":")"},"range":[48,49]},{"type":{"label":","},"range":[49,50]},{"type":{"label":"string"},"value":"findAll should be called with connected args","range":[51,97]},{"type":{"label":")"},"range":[97,98]}]',
    visitorKeys: _powerAssertVisitorKeys
