...
test.serial('User#findAll', async t => {
  ...
  t.true(_rec12._expr(_rec12._capt(_rec12._capt(_rec12._capt(UserStub, 'arguments/0/object/object').findAll, 'arguments/0/object').called, 'arguments/0'), {
  ...
  t.true(_rec13._expr(_rec13._capt(_rec13._capt(_rec13._capt(UserStub, 'arguments/0/object/object').findAll, 'arguments/0/object').calledOnce, 'arguments/0'), {
  ...
  t.true(_rec14._expr(_rec14._capt(_rec14._capt(_rec14._capt(UserStub, 'arguments/0/callee/object/object').findAll, 'arguments/0/callee/object').calledWith(), 'arguments/0'), {
...
test.serial('User#findGroup', async t => {
  ...
  t.true(_rec15._expr(_rec15._capt(_rec15._capt(_rec15._capt(UserStub, 'arguments/0/object/object').findAll, 'arguments/0/object').called, 'arguments/0'), {
    content: 't.true(UserStub.findAll.called, \'findAll should be called on model\')',
    filepath: 'tests/user-tests.js',
    line: 196,
    async: true,
  ...
  t.true(_rec16._expr(_rec16._capt(_rec16._capt(_rec16._capt(UserStub, 'arguments/0/object/object').findAll, 'arguments/0/object').calledOnce, 'arguments/0'), {
    content: 't.true(UserStub.findAll.calledOnce, \'findAll should be called once\')',
    filepath: 'tests/user-tests.js',
    line: 197,
    async: true,
  ...
  t.true(_rec17._expr(_rec17._capt(_rec17._capt(_rec17._capt(UserStub, 'arguments/0/callee/object/object').findAll, 'arguments/0/callee/object').calledWith(_rec17._capt(typeArgs, 'arguments/0/arguments/0')), 'arguments/0'), {
