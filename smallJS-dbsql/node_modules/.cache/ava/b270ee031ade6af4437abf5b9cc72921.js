...
test.serial('User#createOrUpdate - new', async t => {
  ...
  t.true(_rec6._expr(_rec6._capt(_rec6._capt(_rec6._capt(UserStub, 'arguments/0/object/object').findOne, 'arguments/0/object').called, 'arguments/0'), {
  ...
  t.true(_rec7._expr(_rec7._capt(_rec7._capt(_rec7._capt(UserStub, 'arguments/0/object/object').findOne, 'arguments/0/object').calledOnce, 'arguments/0'), {
  ...
  // Una para el ccid
  t.true(_rec8._expr(_rec8._capt(_rec8._capt(_rec8._capt(UserStub, 'arguments/0/callee/object/object').findOne, 'arguments/0/callee/object').calledWith(_rec8._capt({
    where: _rec8._capt({ ccid: _rec8._capt(_rec8._capt(newUser, 'arguments/0/arguments/0/properties/0/value/properties/0/value/object').ccid, 'arguments/0/arguments/0/properties/0/value/properties/0/value'),
      type: _rec8._capt(_rec8._capt(newUser, 'arguments/0/arguments/0/properties/0/value/properties/1/value/object').type, 'arguments/0/arguments/0/properties/0/value/properties/1/value') }, 'arguments/0/arguments/0/properties/0/value')
  }, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(UserStub.findOne.calledWith({ where: { ccid: newUser.ccid, type: newUser.type } }), \'findOne should be called with ccid args\')',
    filepath: 'tests/user-tests.js',
    line: 98,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"UserStub","range":[7,15]},"property":{"type":"Identifier","name":"findOne","range":[16,23]},"computed":false,"range":[7,23]},"property":{"type":"Identifier","name":"calledWith","range":[24,34]},"computed":false,"range":[7,34]},"arguments":[{"type":"ObjectExpression","properties":[{"type":"ObjectProperty","key":{"type":"Identifier","name":"where","range":[37,42]},"value":{"type":"ObjectExpression","properties":[{"type":"ObjectProperty","key":{"type":"Identifier","name":"ccid","range":[46,50]},"value":{"type":"MemberExpression","object":{"type":"Identifier","name":"newUser","range":[52,59]},"property":{"type":"Identifier","name":"ccid","range":[60,64]},"computed":false,"range":[52,64]},"computed":false,"shorthand":false,"range":[46,64]},{"type":"ObjectProperty","key":{"type":"Identifier","name":"type","range":[66,70]},"value":{"type":"MemberExpression","object":{"type":"Identifier","name":"newUser","range":[72,79]},"property":{"type":"Identifier","name":"type","range":[80,84]},"computed":false,"range":[72,84]},"computed":false,"shorthand":false,"range":[66,84]}],"range":[44,86]},"computed":false,"shorthand":false,"range":[37,86]}],"range":[35,88]}],"range":[7,89]},{"type":"StringLiteral","value":"findOne should be called with ccid args","range":[91,132]}],"range":[0,133]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"UserStub","range":[7,15]},{"type":{"label":"."},"range":[15,16]},{"type":{"label":"name"},"value":"findOne","range":[16,23]},{"type":{"label":"."},"range":[23,24]},{"type":{"label":"name"},"value":"calledWith","range":[24,34]},{"type":{"label":"("},"range":[34,35]},{"type":{"label":"{"},"range":[35,36]},{"type":{"label":"name"},"value":"where","range":[37,42]},{"type":{"label":":"},"range":[42,43]},{"type":{"label":"{"},"range":[44,45]},{"type":{"label":"name"},"value":"ccid","range":[46,50]},{"type":{"label":":"},"range":[50,51]},{"type":{"label":"name"},"value":"newUser","range":[52,59]},{"type":{"label":"."},"range":[59,60]},{"type":{"label":"name"},"value":"ccid","range":[60,64]},{"type":{"label":","},"range":[64,65]},{"type":{"label":"name"},"value":"type","range":[66,70]},{"type":{"label":":"},"range":[70,71]},{"type":{"label":"name"},"value":"newUser","range":[72,79]},{"type":{"label":"."},"range":[79,80]},{"type":{"label":"name"},"value":"type","range":[80,84]},{"type":{"label":"}"},"range":[85,86]},{"type":{"label":"}"},"range":[87,88]},{"type":{"label":")"},"range":[88,89]},{"type":{"label":","},"range":[89,90]},{"type":{"label":"string"},"value":"findOne should be called with ccid args","range":[91,132]},{"type":{"label":")"},"range":[132,133]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'findOne should be called with ccid args');

  t.true(_rec9._expr(_rec9._capt(_rec9._capt(_rec9._capt(UserStub, 'arguments/0/object/object').create, 'arguments/0/object').called, 'arguments/0'), {
  ...
  t.true(_rec10._expr(_rec10._capt(_rec10._capt(_rec10._capt(UserStub, 'arguments/0/object/object').create, 'arguments/0/object').calledOnce, 'arguments/0'), {
  ...
  t.true(_rec11._expr(_rec11._capt(_rec11._capt(_rec11._capt(UserStub, 'arguments/0/callee/object/object').create, 'arguments/0/callee/object').calledWith(_rec11._capt(newUser, 'arguments/0/arguments/0')), 'arguments/0'), {
...
test.serial('User#createOrUpdate - exists', async t => {
  ...
  t.true(_rec13._expr(_rec13._capt(_rec13._capt(_rec13._capt(UserStub, 'arguments/0/object/object').findOne, 'arguments/0/object').calledTwice, 'arguments/0'), {
  ...
  // 2 Para el ccid
  t.true(_rec14._expr(_rec14._capt(_rec14._capt(_rec14._capt(UserStub, 'arguments/0/callee/object/object').findOne, 'arguments/0/callee/object').calledWith(_rec14._capt(ccidArgs, 'arguments/0/arguments/0')), 'arguments/0'), {
  ...
  t.true(_rec15._expr(_rec15._capt(_rec15._capt(_rec15._capt(UserStub, 'arguments/0/object/object').update, 'arguments/0/object').called, 'arguments/0'), {
    content: 't.true(UserStub.update.called, \'user.update called on model\')',
    filepath: 'tests/user-tests.js',
    line: 118,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"UserStub","range":[7,15]},"property":{"type":"Identifier","name":"update","range":[16,22]},"computed":false,"range":[7,22]},"property":{"type":"Identifier","name":"called","range":[23,29]},"computed":false,"range":[7,29]},{"type":"StringLiteral","value":"user.update called on model","range":[31,60]}],"range":[0,61]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"UserStub","range":[7,15]},{"type":{"label":"."},"range":[15,16]},{"type":{"label":"name"},"value":"update","range":[16,22]},{"type":{"label":"."},"range":[22,23]},{"type":{"label":"name"},"value":"called","range":[23,29]},{"type":{"label":","},"range":[29,30]},{"type":{"label":"string"},"value":"user.update called on model","range":[31,60]},{"type":{"label":")"},"range":[60,61]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'user.update called on model');
  t.true(_rec16._expr(_rec16._capt(_rec16._capt(_rec16._capt(UserStub, 'arguments/0/object/object').update, 'arguments/0/object').calledOnce, 'arguments/0'), {
    content: 't.true(UserStub.update.calledOnce, \'user.update should be called once\')',
    filepath: 'tests/user-tests.js',
    line: 119,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"UserStub","range":[7,15]},"property":{"type":"Identifier","name":"update","range":[16,22]},"computed":false,"range":[7,22]},"property":{"type":"Identifier","name":"calledOnce","range":[23,33]},"computed":false,"range":[7,33]},{"type":"StringLiteral","value":"user.update should be called once","range":[35,70]}],"range":[0,71]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"UserStub","range":[7,15]},{"type":{"label":"."},"range":[15,16]},{"type":{"label":"name"},"value":"update","range":[16,22]},{"type":{"label":"."},"range":[22,23]},{"type":{"label":"name"},"value":"calledOnce","range":[23,33]},{"type":{"label":","},"range":[33,34]},{"type":{"label":"string"},"value":"user.update should be called once","range":[35,70]},{"type":{"label":")"},"range":[70,71]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'user.update should be called once');
  t.true(_rec17._expr(_rec17._capt(_rec17._capt(_rec17._capt(UserStub, 'arguments/0/callee/object/object').update, 'arguments/0/callee/object').calledWith(_rec17._capt(single, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(UserStub.update.calledWith(single), \'user.update should be called with specified args\')',
    filepath: 'tests/user-tests.js',
    line: 120,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"UserStub","range":[7,15]},"property":{"type":"Identifier","name":"update","range":[16,22]},"computed":false,"range":[7,22]},"property":{"type":"Identifier","name":"calledWith","range":[23,33]},"computed":false,"range":[7,33]},"arguments":[{"type":"Identifier","name":"single","range":[34,40]}],"range":[7,41]},{"type":"StringLiteral","value":"user.update should be called with specified args","range":[43,93]}],"range":[0,94]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"UserStub","range":[7,15]},{"type":{"label":"."},"range":[15,16]},{"type":{"label":"name"},"value":"update","range":[16,22]},{"type":{"label":"."},"range":[22,23]},{"type":{"label":"name"},"value":"calledWith","range":[23,33]},{"type":{"label":"("},"range":[33,34]},{"type":{"label":"name"},"value":"single","range":[34,40]},{"type":{"label":")"},"range":[40,41]},{"type":{"label":","},"range":[41,42]},{"type":{"label":"string"},"value":"user.update should be called with specified args","range":[43,93]},{"type":{"label":")"},"range":[93,94]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'user.update should be called with specified args');
...
//# sourceMappingURL=/home/shersnape/Ceiba/Java-Script/Tutorial/JavaScritp-Platzi/smallJS/smallJS-dbsql/node_modules/.cache/ava/b270ee031ade6af4437abf5b9cc72921.js.map