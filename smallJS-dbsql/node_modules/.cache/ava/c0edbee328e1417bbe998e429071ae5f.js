...
test.serial('SetupandCreate', async t => {
  ...
  //t.true(UserStub.findAll.called, 'findAll should be called on model')
  //t.true(UserStub.findAll.called, 'findAll should be called once')
  t.true(_rec14._expr(_rec14._capt(_rec14._capt(_rec14._capt(UserStub, 'arguments/0/callee/object/object').findAll, 'arguments/0/callee/object').calledWith(_rec14._capt(typeArgs, 'arguments/0/arguments/0')), 'arguments/0'), {
