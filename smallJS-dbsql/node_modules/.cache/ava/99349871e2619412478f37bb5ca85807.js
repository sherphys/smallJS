...
test.serial('User#createOrUpdate - new', async t => {
  ...
  t.true(_rec13._expr(_rec13._capt(_rec13._capt(_rec13._capt(UserStub, 'arguments/0/callee/object/object').findOne, 'arguments/0/callee/object').calledWith(_rec13._capt({
    ...
    content: 't.true(UserStub.findOne.calledWith({ where: { ccid: newUser.ccid } }), \'findOne should be called with uuid args\')',
    filepath: 'tests/user-tests.js',
    line: 176,
    async: true,
...
//# sourceMappingURL=/home/shersnape/Ceiba/Java-Script/Tutorial/JavaScritp-Platzi/smallJS/smallJS-dbsql/node_modules/.cache/ava/99349871e2619412478f37bb5ca85807.js.map