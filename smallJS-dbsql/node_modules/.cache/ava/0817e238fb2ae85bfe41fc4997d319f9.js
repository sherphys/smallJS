...
test.beforeEach(async () => {
  ...
  UserStub.findAll.withArgs(typesArgs).returns(Promise.resolve(userFixtures.types));
...
test.serial('SetupandCreate', async t => {
  ...
  //t.true(UserStub.findAll.called, 'findAll should be called on model')
  //t.true(UserStub.findAll.called, 'findAll should be called once')
  t.true(_rec14._expr(_rec14._capt(_rec14._capt(_rec14._capt(UserStub, 'arguments/0/callee/object/object').findAll, 'arguments/0/callee/object').calledWith(_rec14._capt(typesArgs, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(UserStub.findAll.calledWith(typesArgs), \'findAll should be called without args\')',
    filepath: 'tests/user-tests.js',
    line: 192,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"UserStub","range":[7,15]},"property":{"type":"Identifier","name":"findAll","range":[16,23]},"computed":false,"range":[7,23]},"property":{"type":"Identifier","name":"calledWith","range":[24,34]},"computed":false,"range":[7,34]},"arguments":[{"type":"Identifier","name":"typesArgs","range":[35,44]}],"range":[7,45]},{"type":"StringLiteral","value":"findAll should be called without args","range":[47,86]}],"range":[0,87]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"UserStub","range":[7,15]},{"type":{"label":"."},"range":[15,16]},{"type":{"label":"name"},"value":"findAll","range":[16,23]},{"type":{"label":"."},"range":[23,24]},{"type":{"label":"name"},"value":"calledWith","range":[24,34]},{"type":{"label":"("},"range":[34,35]},{"type":{"label":"name"},"value":"typesArgs","range":[35,44]},{"type":{"label":")"},"range":[44,45]},{"type":{"label":","},"range":[45,46]},{"type":{"label":"string"},"value":"findAll should be called without args","range":[47,86]},{"type":{"label":")"},"range":[86,87]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'findAll should be called without args');
});
