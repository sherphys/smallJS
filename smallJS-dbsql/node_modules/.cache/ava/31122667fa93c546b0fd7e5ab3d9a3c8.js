...
let canceledAppointment = Object.assign({}, appointmentFixtures.apps[1]);
...
test.serial('Appointmet#CanceledAndUpdate - exist - user/admin - customer', async t => {
  ...
  t.true(_rec42._expr(_rec42._capt(_rec42._capt(_rec42._capt(UserStub, 'arguments/0/callee/object/object').findOne, 'arguments/0/callee/object').calledWith(_rec42._capt(ccidArgsCustomer, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(UserStub.findOne.calledWith(ccidArgsCustomer), \'findOne (user) should be called with ccid args\')',
    filepath: 'tests/appointment-tests.js',
    line: 248,
    async: true,
  ...
  t.true(_rec48._expr(_rec48._capt(_rec48._capt(_rec48._capt(AppointmentStub, 'arguments/0/callee/object/object').update, 'arguments/0/callee/object').calledWith(_rec48._capt(changeAppointment, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(AppointmentStub.update.calledWith(changeAppointment), \'appointment.update should be called with specified args\')',
    filepath: 'tests/appointment-tests.js',
    line: 261,
    async: true,
...
//# sourceMappingURL=/home/shersnape/Ceiba/Java-Script/Tutorial/JavaScritp-Platzi/smallJS/smallJS-dbsql/node_modules/.cache/ava/31122667fa93c546b0fd7e5ab3d9a3c8.js.map