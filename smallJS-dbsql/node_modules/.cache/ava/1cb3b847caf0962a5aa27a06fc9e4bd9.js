...
test.serial('User#createOrUpdate - new', async t => {
  ...
  t.true(_rec16._expr(_rec16._capt(_rec16._capt(_rec16._capt(UserStub, 'arguments/0/callee/object/object').findOne, 'arguments/0/callee/object').calledWith(_rec16._capt({
    where: _rec16._capt({ ccid: _rec16._capt(_rec16._capt(newUser, 'arguments/0/arguments/0/properties/0/value/properties/0/value/object').ccid, 'arguments/0/arguments/0/properties/0/value/properties/0/value') }, 'arguments/0/arguments/0/properties/0/value')
...
test.serial('User#createOrUpdate - exists', async t => {
  ...
  t.true(_rec20._expr(_rec20._capt(_rec20._capt(_rec20._capt(UserStub, 'arguments/0/object/object').findOne, 'arguments/0/object').called, 'arguments/0'), {
    content: 't.true(UserStub.findOne.called, \'findOne should be called on model\')',
    filepath: 'tests/user-tests.js',
    line: 149,
    async: true,
  ...
  t.true(_rec21._expr(_rec21._capt(_rec21._capt(_rec21._capt(UserStub, 'arguments/0/object/object').findOne, 'arguments/0/object').calledTwice, 'arguments/0'), {
  ...
  // 2 Para el ccid
  t.true(_rec22._expr(_rec22._capt(_rec22._capt(_rec22._capt(UserStub, 'arguments/0/callee/object/object').findOne, 'arguments/0/callee/object').calledWith(_rec22._capt(ccidArgs, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(UserStub.findOne.calledWith(ccidArgs), \'findOne should be called with ccid args\')',
    filepath: 'tests/user-tests.js',
    line: 152,
    async: true,
  ...
  t.true(_rec23._expr(_rec23._capt(_rec23._capt(_rec23._capt(UserStub, 'arguments/0/object/object').update, 'arguments/0/object').called, 'arguments/0'), {
  ...
  t.true(_rec24._expr(_rec24._capt(_rec24._capt(_rec24._capt(UserStub, 'arguments/0/object/object').update, 'arguments/0/object').calledOnce, 'arguments/0'), {
  ...
  t.true(_rec25._expr(_rec25._capt(_rec25._capt(_rec25._capt(UserStub, 'arguments/0/callee/object/object').update, 'arguments/0/callee/object').calledWith(_rec25._capt(single, 'arguments/0/arguments/0')), 'arguments/0'), {
