...
test.serial('Appointmet#CanceledAndUpdate - exist - user/admin - customer', async t => {
  ...
  t.true(_rec45._expr(_rec45._capt(_rec45._capt(_rec45._capt(AppointmentStub, 'arguments/0/callee/object/object').findById, 'arguments/0/callee/object').calledWith(_rec45._capt(_rec45._capt(changeAppointment, 'arguments/0/arguments/0/object').id, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(AppointmentStub.findById.calledWith(changeAppointment.id), \'findById (appoint) should be called with vargs\')',
    filepath: 'tests/appointment-tests.js',
    line: 261,
    async: true,
