...
test.serial('Appointmet#AssignedAndUpdate - exist - user - customer', async t => {
  ...
  t.true(_rec33._expr(_rec33._capt(_rec33._capt(_rec33._capt(UserStub, 'arguments/0/callee/object/object').findOne, 'arguments/0/callee/object').calledWith(_rec33._capt(ccidArgs, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(UserStub.findOne.calledWith(ccidArgs), \'findOne (user) should be called with ccid args\')',
    filepath: 'tests/appointment-tests.js',
    line: 213,
    async: true,
  ...
  // Luego buscamos la cita (que ya existe)
  t.true(_rec34._expr(_rec34._capt(_rec34._capt(_rec34._capt(AppointmentStub, 'arguments/0/object/object').findOne, 'arguments/0/object').called, 'arguments/0'), {
    content: 't.true(AppointmentStub.findOne.called, \'findOne (appoint) should be called on model\')',
    filepath: 'tests/appointment-tests.js',
    line: 216,
    async: true,
  ...
  t.true(_rec35._expr(_rec35._capt(_rec35._capt(_rec35._capt(AppointmentStub, 'arguments/0/object/object').findOne, 'arguments/0/object').calledOnce, 'arguments/0'), {
    content: 't.true(AppointmentStub.findOne.calledOnce, \'findOne (appoint) should be called twice\')',
    filepath: 'tests/appointment-tests.js',
    line: 217,
    async: true,
  ...
  t.true(_rec36._expr(_rec36._capt(_rec36._capt(_rec36._capt(AppointmentStub, 'arguments/0/callee/object/object').findOne, 'arguments/0/callee/object').calledWith(_rec36._capt(vArgs, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(AppointmentStub.findOne.calledWith(vArgs), \'findOne (appoint) should be called with vargs\')',
    filepath: 'tests/appointment-tests.js',
    line: 218,
    async: true,
  ...
  // Volvemos a buscarlas por el id
  t.true(_rec37._expr(_rec37._capt(_rec37._capt(_rec37._capt(AppointmentStub, 'arguments/0/object/object').findById, 'arguments/0/object').called, 'arguments/0'), {
    content: 't.true(AppointmentStub.findById.called, \'findById (appoint) should be called on model\')',
    filepath: 'tests/appointment-tests.js',
    line: 221,
    async: true,
  ...
  t.true(_rec38._expr(_rec38._capt(_rec38._capt(_rec38._capt(AppointmentStub, 'arguments/0/object/object').findById, 'arguments/0/object').calledOnce, 'arguments/0'), {
    content: 't.true(AppointmentStub.findById.calledOnce, \'findById (appoint) should be called twice\')',
    filepath: 'tests/appointment-tests.js',
    line: 222,
    async: true,
  ...
  t.true(_rec39._expr(_rec39._capt(_rec39._capt(_rec39._capt(AppointmentStub, 'arguments/0/callee/object/object').findById, 'arguments/0/callee/object').calledWith(_rec39._capt(_rec39._capt(oneAppointment, 'arguments/0/arguments/0/object').id, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(AppointmentStub.findById.calledWith(oneAppointment.id), \'findById (appoint) should be called with vargs\')',
    filepath: 'tests/appointment-tests.js',
    line: 223,
    async: true,
  ...
  // Al encontrarla, la actualizamos
  t.true(_rec40._expr(_rec40._capt(_rec40._capt(_rec40._capt(AppointmentStub, 'arguments/0/object/object').update, 'arguments/0/object').called, 'arguments/0'), {
    content: 't.true(AppointmentStub.update.called, \'appointment.update called on model\')',
    filepath: 'tests/appointment-tests.js',
    line: 226,
    async: true,
  ...
  t.true(_rec41._expr(_rec41._capt(_rec41._capt(_rec41._capt(AppointmentStub, 'arguments/0/object/object').update, 'arguments/0/object').calledOnce, 'arguments/0'), {
    content: 't.true(AppointmentStub.update.calledOnce, \'appointment.update should be called once\')',
    filepath: 'tests/appointment-tests.js',
    line: 227,
    async: true,
  ...
  t.true(_rec42._expr(_rec42._capt(_rec42._capt(_rec42._capt(AppointmentStub, 'arguments/0/callee/object/object').update, 'arguments/0/callee/object').calledWith(_rec42._capt(oneAppointment, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(AppointmentStub.update.calledWith(oneAppointment), \'appointment.update should be called with specified args\')',
    filepath: 'tests/appointment-tests.js',
    line: 228,
    async: true,
...
//# sourceMappingURL=/home/shersnape/Ceiba/Java-Script/Tutorial/JavaScritp-Platzi/smallJS/smallJS-dbsql/node_modules/.cache/ava/1436eef3bbf51bc9797d2cb4621188d2.js.map