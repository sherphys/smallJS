...
test.beforeEach(async () => {
  ...
  AppointmentStub.update.withArgs(oneAppointment, assign).returns(Promise.resolve(appointmentFixtures.extend(oneAppointment, assign)));
  ...
  UserStub.findOne.withArgs(ccidchange).returns(Promise.resolve(appointmentFixtures.byCCidCustomer(ccidchange)));
...
test.serial('Appointmet#AssignedAndUpdate - exist - user - customer', async t => {
  ...
  console.log('User cal: ' + JSON.stringify(appointmentFixtures.byCCidCustomer(ccidchange)) + '\n\n');
  console.log('User cal: ' + JSON.stringify(appointmentFixtures.byId(appointmentchange)) + '\n\n');
  ...
  t.true(_rec35._expr(_rec35._capt(_rec35._capt(_rec35._capt(AppointmentStub, 'arguments/0/object/object').findById, 'arguments/0/object').calledOnce, 'arguments/0'), {
    content: 't.true(AppointmentStub.findById.calledOnce, \'findById (appoint) should be called twice\')',
    filepath: 'tests/appointment-tests.js',
    line: 233,
    async: true,
  ...
  t.true(_rec36._expr(_rec36._capt(_rec36._capt(_rec36._capt(AppointmentStub, 'arguments/0/callee/object/object').findById, 'arguments/0/callee/object').calledWith(_rec36._capt(appointmentchange, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(AppointmentStub.findById.calledWith(appointmentchange), \'findById (appoint) should be called with vargs\')',
    filepath: 'tests/appointment-tests.js',
    line: 234,
    async: true,
