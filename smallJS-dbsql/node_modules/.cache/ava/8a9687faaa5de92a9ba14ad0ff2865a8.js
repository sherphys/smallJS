...
test.serial('Agent#findOne', async t => {
  ...
  let user = await db.User.createOrUpdate(newUser); //await db.User.findOne(condips)
  ...
  t.true(_rec13._expr(_rec13._capt(_rec13._capt(_rec13._capt(UserStub, 'arguments/0/callee/object/object').findOne, 'arguments/0/callee/object').calledWith(_rec13._capt(condips, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(UserStub.findOne.calledWith(condips), \'findOne should be called with uuid args\')',
    filepath: 'tests/user-tests.js',
    line: 133,
    async: true,
